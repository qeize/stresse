...
var KTHeaderMobile = function () {

    var handleMobileHeader = function () {
        // Hide toolbar on mobile
        var header = document.querySelector("#kt_header");
        var toolbar = header ? header.querySelector(".toolbar") : null;
...
var KTLayoutAside = function () {
    ...
    var handleToggle = function () {
        ...
        // Store sidebar minimize state in LocalStorage
        toggleObj.on('kt.toggle.changed', function () {
            // In server side check localStorage for "aside_minimize_state" value and
            // add data-kt-app-sidebar-minimize="on" attribute to Body tag and "active" class to the toggle button
...
var Loader = function () {
    var removeLoader = function () {
        $("#loader-container").fadeOut(500, function () {
            $(this).remove(); // remove the loader container from the DOM
        });
    };
