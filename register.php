        ...
        <div class="d-flex flex-center w-lg-50 p-10">
            ...
            <div class="card rounded-1 w-md-650px">
                ...
                <div class="card-body p-10 p-lg-6">
                    <!--begin::Form-->
                    <form method="POST" class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="Register">
                        <!--begin::Heading-->
                        ...
                        <div class="input-group input-group-solid mb-5">
                            ...
                            <input type="text" class="form-control" autocomplete="off" name="Username" placeholder="Username" aria-label="Username">
                        </div>
                        <!--end::Input group=-->
                        <div class="input-group input-group-solid mb-5">
                            ...
                            <input type="password" class="form-control" autocomplete="off" aria-autocomplete=none name="Password1" placeholder="Password" aria-label="Password">
                        </div>
                        <!--end::Input group=-->
                        <!--end::Input group=-->
                        <div class="input-group input-group-solid mb-5">
                            ...
                            <input type="password" class="form-control" autocomplete="off" name="Password2" placeholder="Confirm Password" aria-label="Password">
                        </div>
                        <!--end::Input group=-->
                        <div class="row d-flex flex-center">
                            <div class="mb-5 text-center">
                                <img class="border-3" id="CaptchaImg" src="captcha" alt="Captcha Code">
                            </div>
                            <div class="input-group input-group-solid mb-5">
                                <span class="input-group-text">
                                ...
                                <input type="text" class="form-control fw-bold" name="CaptchaCode" placeholder="Captcha" aria-label="Captcha">
                            </div>
                            <!--end::Input group=-->
                        </div>
                        <!--begin::Submit button-->
                        ...
                        <!--end::Submit button-->
                        <!--begin::Sign In-->
                        <div class="text-gray-500 text-center fw-bold fs-6 mt-2">You have aleredy account?
